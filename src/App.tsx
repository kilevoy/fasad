          ...
          >
            <div className="modal-head">
              <div>
                ...
                <div className="section-sub">Краткая справка по составу и правилам расчета.</div>
              </div>
            ...
            <div className="help-content">
              <h3>Состав</h3>
              <p>КВП 200/250, вертикальная направляющая НПП 60x27x1,0, паронитовая прокладка, шайба усиления Ш50, анкер/дюбель и заклепки сталь/сталь.</p>

              <h3>Нормы</h3>
              <p>Шаг кронштейнов определяется расчетом. В калькуляторе MVP принят консервативный максимум 800 мм. Компенсационный зазор между направляющими 5-10 мм, температурные деформации 1,2-1,5 мм/п.м.</p>

              <h3>Расчет</h3>
              <p>Вертикальные линии берутся по раскладке кассет. Ряды кронштейнов: ceil(высота фасада / шаг) + 1. Кронштейны: вертикальные линии × ряды кронштейнов × количество фасадов.</p>

              <h3>Профили 3 м</h3>
              <p>Направляющие стыкуются с зазором 5-10 мм и не скрепляются в жесткую непрерывную линию. Для монтажной схемы считать хлысты по каждой вертикальной линии: ceil(высота / 3000).</p>
      ...
      {doubleLevelHelpOpen ? (
        <div className="modal-backdrop" role="presentation" onClick={() => setDoubleLevelHelpOpen(false)}>
          ...
          >
            ...
            <div className="help-content">
              <h3>Состав</h3>
              <p>КВП, вертикальные НПП 60x27, горизонтальные НПП 60x27, основной НПШ 20x80x20 1,0, промежуточный НПШ 20x80x20 1,0 при длине кассеты более 800 мм, паронитовая прокладка, шайба усиления, анкеры и заклепки.</p>

              <h3>Нормы</h3>
              <p>Вертикальные НПП: шаг 600-800 мм. Горизонтальные НПП: шаг до 800 мм. Температурные деформации 1,2-1,5 мм/п.м., компенсационные зазоры между направляющими 5-10 мм.</p>

              <h3>Профили под кассеты</h3>
              <p>Для калькулятора основной и промежуточный вертикальный профиль принимается как НПШ 20x80x20 1,0. Если длина кассеты больше 800 мм, промежуточный профиль обязателен.</p>

              <h3>Особенности КФ-2 и КФ-3</h3>
              <p>Профили, формирующие видимую часть вертикального шва, должны быть в цвет кассет или закрыты декоративной полосой.</p>
